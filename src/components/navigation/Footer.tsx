      ...
      <footer className="w-full bg-black text-white">
        <div className="mx-auto max-w-[1680px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            <div className="col-span-full space-y-4 mb-10 lg:col-span-2 lg:mb-0">
              <Link to="/" className="flex items-baseline-last gap-2">
                <img src={lightLogo} alt="logo" className="h-[1.5em]" />
                <span className="logoText lowercase">rootscards</span>
              </Link>

              <Link
                to="#"
                className="flex items-center gap-2 py-2.5 px-4 w-fit bg-[#1EAE54] rounded-full shadow-sm text-xs text-white mx-auto "
              >
          ...
          <div className="py-7 border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span className="text-sm text-gray-500 ">
                ©<Link to="/">rootscards</Link> 2025, All rights reserved.
              </span>
