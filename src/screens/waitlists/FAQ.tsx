...
export const FAQ = ({
  ...
  return (
    <div className="w-full bg-[#E7E6D7]">
      <div className="py-20 px-4 md:px-8 max-w-[1400px] mx-auto flex flex-col md:flex-row gap-12">
        {/* Left side */}
        <div className="flex flex-col text-left basis-1/2">
          {typeof title === "string" ? (
            <p className="hThree titleFont font-semibold whitespace-pre-line md:leading-14 w-1/2">
              {title}
            </p>
          ) : (
            title
